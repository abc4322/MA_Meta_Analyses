---
title: An R Markdown document converted from "MA_Meta_Anylses/Meta.Analysis.ipynb"
...
# includes...
  ...
  # print plots or data
  print.forest = FALSE, print.funnel = FALSE, funnel.label = TRUE, print.meta.results = FALSE,
...
# Print Forest plot or descriptive or meta-results
    ...
    if(results.meta$k >= 3){
      ...
      if (print.baujat){
        # results.influence.meta <- InfluenceAnalysis(results.meta, random = TRUE)
...
# Funnel plot
    ...
    funnel(
      trim.and.fill, legend = TRUE,  yaxis="seinv", label = ifelse(funnel.label, TRUE, FALSE),
